...
/**
 * The whole specification against rung three, through the public interface only. The same suite the
...
class CorpusConformanceTest {
  ...
  void the_fixture_holds(final Fixture fixture) {
    final CorpusRunner.Result result = CorpusRunner.run(fixture, new FlyweightEngineFactory());
