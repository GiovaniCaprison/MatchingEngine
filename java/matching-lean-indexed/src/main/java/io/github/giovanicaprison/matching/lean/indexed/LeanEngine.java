...
/**
 * Rung one's lean twin: limit and market orders, price-time, on the indexed book.
 *
 ...
 *
 * <p>On the shared remit this engine, the full indexed rung, and both rung zero arms are byte
