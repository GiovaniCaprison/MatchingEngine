 ...
 *
 * <p>Emitting rather than returning is what keeps an engine off the allocator (P-8). A consumer
 * that only counts executions materialises nothing at all.
 *
 ...
 *
 * <p>The slice is valid for the duration of the call and no longer. A consumer that needs to keep
 * an event copies it.
 */
