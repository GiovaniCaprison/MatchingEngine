// Rung one's lean twin in this language: limit and market orders, price-time, on the indexed
// book, at a layout matched to the Java arm. METHODOLOGY's first question is what a real venue's
...
#include "lean-indexed/book.hpp"
#include "lean-indexed/feed.hpp"

namespace io::github::giovanicaprison::matching::lean::indexed {

class LeanEngine final : public api::MatchingEngine {
 public:
  explicit LeanEngine(api::EventPublisher& events) : feed_(events) {}
