 ...
 * @param orderId the engine uid the client uses to cancel or amend (FR-1.3)
 ...
 *     serialise them anyway (OOD-3). A publishing consumer takes them from the sink and allocates
 *     nothing.
 */
public record Accepted(long clientOrderId, long orderId, SubmitOutcome outcome, Seq<Trade> fills)
